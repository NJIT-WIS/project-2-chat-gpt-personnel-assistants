        ...
        <div className="min-h-screen px-4 text-center">
          ...
          >
            ...
            <p className="mt-4 text-gray-600">
              In accordance with the EU General Data Protection Regulation (GDPR), we need your consent to store and use
              cookies and other tracking technologies. These technologies help us enhance your browsing experience, display
              personalized content and ads, analyze website traffic, and better understand our visitors. By clicking "Okay," you
              give your consent for us to use these technologies. To learn more or update your preferences, please read our{' '}
